...
const RULES = {
  ss: {
    ...
    sizes: { grid: ".t.jpg", full: ".800.jpg", tiny: ".th2.jpg" },
  },
  c24: {
    host: "https://static.img-city24.lv/object/",
    derive: "stem",
    sizes: { grid: "14", full: "22", tiny: "15" },
  },
  pp: {
    ...
    sizes: { grid: "43", full: "0x1080", tiny: "thumb" },
  },
  ...
  var: {
    ...
    derive: "prefix",
    sizes: { grid: "small_", full: "original_", tiny: "small_" },
  },
  ...
  lat: {
    ...
    derive: "mid",
    sizes: { grid: "th/c_w410_h300_cm2_v1_", full: "", tiny: "th/c_w410_h300_cm2_v1_" },
  },
